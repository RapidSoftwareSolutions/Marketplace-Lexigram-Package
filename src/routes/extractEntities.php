...
$app->post('/api/Lexigram/extractEntities', function ($request, $response) {
    ...
    $url = $settings['apiUrl'] . "/extract/entities";
    ...
    if (isset($postData['args']['withText']) && strlen($postData['args']['withText']) > 0) {
        $params['withText'] = filter_var($postData['args']['withText']);
    }
