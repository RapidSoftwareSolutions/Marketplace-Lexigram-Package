...
$app->post('/api/Lexigram/getConceptDescendants', function ($request, $response) {
    ...
    $url = $settings['apiUrl'] . "/lexigraph/concepts/" . $postData['args']['conceptId'] . "/descendants";
    ...
    if (isset($postData['args']['page']) && strlen($postData['args']['page']) > 0) {
        $params['page'] = (int)$postData['args']['page'] ? (int)$postData['args']['page'] : 1;
    }
